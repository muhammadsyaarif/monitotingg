...
export default function Homepage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center p-4 bg-white text-black sm:p-8">
      ...
      <div className="relative z-10 text-center max-w-4xl">
        {/* Header */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight drop-shadow-lg mb-4 sm:mb-6 animate-pulse">
        ...
        <div className="mt-8 space-y-4 sm:space-y-6">
          <h2 className="text-2xl sm:text-3xl font-bold">Data Terkini:</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 mt-4">
            {temperature !== null ? (
              <p className="text-xl sm:text-2xl font-semibold bg-purple-600 p-3 sm:p-4 rounded-lg shadow-lg text-white">
                Suhu: {temperature} °C
              </p>
            ) : (
            ...
            {jarak !== null ? (
              <p className="text-xl sm:text-2xl font-semibold bg-pink-600 p-3 sm:p-4 rounded-lg shadow-lg text-white">
                Jarak: {jarak} cm
              </p>
            ) : (
            ...
            {gas !== null ? (
              <p className="text-xl sm:text-2xl font-semibold bg-blue-600 p-3 sm:p-4 rounded-lg shadow-lg text-white">
                Gas: {gas} Ppm
              </p>
            ) : (
        ...
        <div className="flex flex-col space-y-4 sm:mt-6 items-center text-center">
          <Link
            href="/monitoring"
            className="relative inline-block px-6 sm:px-8 py-3 sm:py-4 text-lg sm:text-xl font-bold text-white bg-gradient-to-r from-green-400 to-blue-500 rounded-full shadow-lg hover:scale-105 hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 transition duration-300 ease-in-out"
          >
            Lihat Monitoring
          </Link>
          ...
          <div className="mt-8 sm:mt-12 space-y-4 sm:space-y-6">
            ...
            <Link
              href="/AboutUs"
              className="relative inline-block px-6 sm:px-8 py-3 sm:py-4 text-lg sm:text-xl font-bold text-white bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full shadow-lg hover:scale-105 hover:bg-gradient-to-r hover:from-orange-500 hover:to-yellow-400 transition duration-300 ease-in-out"
            >
              About Us
            </Link>
          </div>
